...
def pdf_analysis():
    ...
    final_pdf_name=makePDF('filename',summary,'Word count = '+ str(word_count), 'graph1.png',
            'graph2.png','graph3.png','graph4.png',reading_time)
...
def starting_png_generation():
    ...
    names=["Text", "Average Word Length", "Average Sentence Length", "Punctuation per Sentence", "Ratio of Unique Words to Total"]
    # list of stopwords
...
def generate_plots(text,"YourDoc"):
    quantify2(text, "YourDoc")
    mylist = [['Alice in W.', 4.09174276576889, 15.76709796672828, 2.252612169637369,
                0.2138],
                ['P and P', 4.416975965424522, 19.530199151159, 1.8806383325191336, 0.2226],
                ['Scientific', 5.234590256196931, 18.45785876993166, 2.570383125269049,
                0.188],
                ['CS Lewis', 4.078806634633656, 14.062934362934364, 0.936006168080185, 0.207],
